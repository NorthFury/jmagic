...
public final class RunicRepetition extends Card
{
	public RunicRepetition(GameState state)
	{
		...
		SetGenerator targetingRestriction = Intersect.instance(InZone.instance(ExileZone.instance()), Cards.instance(), HasKeywordAbility.instance(Flashback.class), OwnedBy.instance(You.instance()));
