...
public final class EternityVessel extends Card
{
	...
	public EternityVessel(GameState state)
	{
		...
		this.addAbility(new EntersTheBattlefieldWithCounters(state, "Eternity Vessel", LifeTotalOf.instance(You.instance()), "X charge counters on it, where X is your life total", Counter.CounterType.CHARGE));
