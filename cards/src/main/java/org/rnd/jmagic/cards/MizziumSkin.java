...
public final class MizziumSkin extends Card
{
	public MizziumSkin(GameState state)
	{
		...
		this.addEffect(ptChangeAndAbilityUntilEndOfTurn(target, +0, +1, "Target creature you control gets +0/+1 and gains hexproof until end of turn.", Hexproof.class));
		...
		// "each.")
		this.addAbility(new Overload(state, "(1)(U)"));
	}
}
