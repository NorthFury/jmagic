...
public final class Stonewright extends Card
{
	public Stonewright(GameState state)
	{
		...
		this.addAbility(new AbilityIfPaired.Final(state, "As long as Stonewright is paired with another creature, each of those creatures has \"(R): This creature gets +1/+0 until end of turn.\"", Firebreathing.class));
	}
}
