...
public final class RicochetTrap extends Card
{
	 ...
	 */
	public static final class BlueSpellsCast extends Tracker<Collection<Integer>>
	{
	...
	public static final class OpponentCastABlueSpellThisTurn extends SetGenerator
	{
		...
		public MagicSet evaluate(GameState state, Identified thisObject)
		{
			...
			Collection<Integer> trackerValue = state.getTracker(BlueSpellsCast.class).getValue(state);
	...
	public RicochetTrap(GameState state)
	{
		...
		this.addAbility(new Trap(state, this.getName(), oppCastBlue, "If an opponent cast a blue spell this turn", "(R)"));
