...
public final class TraitorousBlood extends Card
{
	public TraitorousBlood(GameState state)
	{
		...
		this.addEffect(createFloatingEffect("Gain control of target creature until end of turn. It gains trample and haste until end of turn.", controlPart, addAbilityToObject(target, Haste.class, Trample.class)));
