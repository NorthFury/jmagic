...
public final class SilverbladePaladin extends Card
{
	public SilverbladePaladin(GameState state)
	{
		...
		this.addAbility(new AbilityIfPaired.Final(state, "As long as Silverblade Paladin is paired with another creature, both creatures have double strike.", DoubleStrike.class));
	}
}
