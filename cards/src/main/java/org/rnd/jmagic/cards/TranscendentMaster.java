...
public final class TranscendentMaster extends Card
{
	...
	public TranscendentMaster(GameState state)
	{
		...
		// 6/6
		// Lifelink
		this.addAbility(new Level(state, 6, 11, 6, 6, "Lifelink", Lifelink.class));

		// LEVEL 12+
		// 9/9
		// Lifelink
		// Transcendent Master is indestructible.
		this.addAbility(new Level(state, 12, 9, 9, "Lifelink; Transcendent Master is indestructible.", Lifelink.class, ThisIsIndestructible.class));
	}
}
