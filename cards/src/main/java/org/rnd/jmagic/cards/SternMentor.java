...
public final class SternMentor extends Card
{
	...
	public SternMentor(GameState state)
	{
		...
		this.addAbility(new AbilityIfPaired.Final(state, "As long as Stern Mentor is paired with another creature, each of those creatures has \"(T): Target player puts the top two cards of his or her library into his or her graveyard.\"", TapMill.class));
	}
}
