...
public final class GravityWell extends Card
{
	public static final class DropItLikeItsHot extends EventTriggeredAbility
	{
		public DropItLikeItsHot(GameState state)
		{
			...
			pattern.put(EventType.Parameter.OBJECT, Intersect.instance(CreaturePermanents.instance(), HasKeywordAbility.instance(Flying.class)));
			...
			part.parameters.put(ContinuousEffectType.Parameter.ABILITY, Identity.instance(Flying.class));
