...
public final class CorrosiveGale extends Card
{
	public CorrosiveGale(GameState state)
	{
		...
		this.addEffect(spellDealDamage(ValueOfX.instance(This.instance()), Intersect.instance(CreaturePermanents.instance(), HasKeywordAbility.instance(Flying.class)), "Corrosive Gale deals X damage to each creature with flying."));
	}
}
