...
public final class Moonmist extends Card
{
	public Moonmist(GameState state)
	{
		...
		PreventCombatDamage prevent = new PreventCombatDamage(this.game, nonFurries, "Prevent all combat damage that would be dealt this turn by creatures other than Werewolves and Wolves.");
