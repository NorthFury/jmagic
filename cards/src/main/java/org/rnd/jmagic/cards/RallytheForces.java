...
public final class RallytheForces extends Card
{
	public RallytheForces(GameState state)
	{
		...
		// turn.
		this.addEffect(ptChangeAndAbilityUntilEndOfTurn(Attacking.instance(), +1, +0, "Attacking creatures get +1/+0 and gain first strike until end of turn.", FirstStrike.class));
	}
}
