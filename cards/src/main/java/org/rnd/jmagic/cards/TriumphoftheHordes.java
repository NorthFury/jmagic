...
public final class TriumphoftheHordes extends Card
{
	public TriumphoftheHordes(GameState state)
	{
		...
		// counters.)
		this.addEffect(ptChangeAndAbilityUntilEndOfTurn(CREATURES_YOU_CONTROL, +1, +1, "Until end of turn, creatures you control get +1/+1 and gain trample and infect.", Trample.class, Infect.class));
	}
}
