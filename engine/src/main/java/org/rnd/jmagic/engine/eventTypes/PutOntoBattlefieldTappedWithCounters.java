...
{	public static final EventType INSTANCE = new PutOntoBattlefieldTappedWithCounters();
	...
	public boolean perform(Game game, Event event, java.util.Map<Parameter, MagicSet> parameters)
	{
		...
		{
			MagicSet numberParameter = parameters.get(Parameter.NUMBER);
		...
		MagicSet object = NewObjectOf.instance(putOntoBattlefield.getResultGenerator()).evaluate(game.actualState, null);
